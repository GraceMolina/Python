"""
convert a list of 2-tuples to a dictionary, and a dictionary to a list of 2-tuples
"""

def covert_list_to_dict(namelist):
    """
    Takes a list of 2-tuples and returns a dictionary. Each 2-tuple is converted to an 
...
def convert_dict_to_list(namedict):
    """
    Takes a dictionary and returns a list of 2-tuples. Each item in the 
    dictionary is converted to a 2-tuple, where the key is the first component 
